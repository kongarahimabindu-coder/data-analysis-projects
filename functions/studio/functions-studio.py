...
print(reverse_characters(test_2))  
print(reverse_characters(test_3))  
print(reverse_characters(test_4)) 
...
print(reverse_characters(56.89))   
...
def complete_reversal(old_list):
    reversed_list = []
    for value in old_list:
        reversed_item = reverse_characters(value)
        reversed_list.insert(0, reversed_item)  
    return reversed_list
